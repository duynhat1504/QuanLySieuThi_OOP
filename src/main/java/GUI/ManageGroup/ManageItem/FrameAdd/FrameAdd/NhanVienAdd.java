...
public class NhanVienAdd extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        imagePanel1
                .setImage(new javax.swing.ImageIcon(getClass().getResource("/GUI/ManageGroup/ManagerIcon/staff.png"))); // NOI18N
        ...
        jComboBox2.setModel(
                new javax.swing.DefaultComboBoxModel<>(new String[] { "Nhân viên bán hàng", "Quản lý cửa hàng" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NhanVienAdd.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
    ...
    public NhanVien kiemTraVaTraDuLieu(int maNV) {
        ...
        if (!nhanvienValidate.validateAll(tenNhanVien, soDienThoai, cmnd, diachi, email)) {
            ...
            // (int maNV, String tenNV, boolean gioiTinh, String cmnd, Date ngaySinh, String
            // soDienThoai, String email, String diaChi, Date ngayThamGia, int maChucVu,
            // boolean isDeleted)
            NhanVien nhanVien = new NhanVien(maNV, tenNhanVien, gioiTinh, cmnd, date, soDienThoai, email, diachi, date1,
                    maChucVu, false);
