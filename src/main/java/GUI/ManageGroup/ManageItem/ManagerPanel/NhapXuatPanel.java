...
public class NhapXuatPanel extends javax.swing.JPanel {
    ...
    private void setUpPanel() {
        // ----- Đổi màu CHỮ của bảng phiếu nhập -----
jTable1.setForeground(new Color(255, 255, 255));  // chữ đỏ

// ----- Đổi màu CHỮ của bảng phiếu hủy -----
jTable2.setForeground(new Color(255, 255, 255));  // chữ đỏ

       // ------- Đổi màu HEADER của bảng nhập -------
jTable1.getTableHeader().setOpaque(true);
jTable1.getTableHeader().setBackground(new Color(128, 0, 0));   // màu đỏ
jTable1.getTableHeader().setForeground(Color.WHITE);            // chữ trắng

// ------- Đổi màu HEADER của bảng hủy -------
jTable2.getTableHeader().setOpaque(true);
jTable2.getTableHeader().setBackground(new Color(128, 0, 0));   // màu đỏ
jTable2.getTableHeader().setForeground(Color.WHITE);            // chữ trắng
    ...
    private void initComponents() {
        ...
        jLabel101.setForeground(new java.awt.Color(128, 0, 0));
        ...
        jLabel103.setForeground(new java.awt.Color(128, 0, 0));
        ...
        jPanel20.setBackground(new java.awt.Color(128, 0, 0));
        ...
        button15.setBackground(new java.awt.Color(128, 0, 0));
        ...
        jPanel13.setBackground(new java.awt.Color(128, 0, 0));//dang xet
        ...
        jLabel120.setForeground(new java.awt.Color(128, 0, 0));
        ...
        jLabel102.setForeground(new java.awt.Color(128, 0, 0));
        ...
        button17.setBackground(new java.awt.Color(128, 0, 0));
        ...
        roundPanel2.setBackground(new java.awt.Color(128, 0, 0));
        ...
        roundPanel3.setBackground(new java.awt.Color(128, 0, 0 ));
