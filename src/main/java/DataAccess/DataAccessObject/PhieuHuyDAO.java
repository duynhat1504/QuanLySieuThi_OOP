...
public class PhieuHuyDAO extends AbstractAccessData<PhieuHuy> implements ISimpleAccess<PhieuHuy,Integer> {
    {
    ...
    public PhieuHuy selectNewest(){
        return executeQuery("SELECT * FROM PhieuHuy WHERE IS_DELETED = 0 ORDER BY MAPHIEU DESC LIMIT 1");
    }
