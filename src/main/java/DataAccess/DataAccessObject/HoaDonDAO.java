...
public class HoaDonDAO extends AbstractAccessData<HoaDon> implements ISimpleAccess<HoaDon,Integer> {
    ...
    public HoaDon selectNewestBill(){
        return executeQuery("SELECT * FROM HOADON WHERE IS_DELETED = 0 ORDER BY MAHD DESC LIMIT 1");
