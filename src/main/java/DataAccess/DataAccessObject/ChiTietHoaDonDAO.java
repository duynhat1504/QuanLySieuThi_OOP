...
public class ChiTietHoaDonDAO extends AbstractAccessData<ChiTietHoaDon> implements ISimpleAccessDetail<ChiTietHoaDon,Integer,Integer> {
    ...
    public boolean delete(Integer maHoaDon, Integer maSanPham) {
        return executeUpdate("DELETE FROM CTHOADON WHERE MAHD = ? AND MASP = ? AND IS_DELETE=0",maHoaDon,maSanPham);
    }
