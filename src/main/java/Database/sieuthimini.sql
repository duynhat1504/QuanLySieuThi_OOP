...
-- TENSP từ varchar(50) -> 100
-- ALTER TABLE SANPHAM
-- MODIFY COLUMN TENSP VARCHAR(100);
...
-- Sửa SODIENTHOAI từ INT(11) sang VARCHAR(15)
-- ALTER TABLE NHANVIEN 
-- MODIFY COLUMN SODIENTHOAI VARCHAR(15);
...
# Xóa data cũ
SET SQL_SAFE_UPDATES = 0;     -- Tắt chế độ Safe Update (để sửa lỗi 1175)
SET FOREIGN_KEY_CHECKS = 0; -- Tắt kiểm tra khóa ngoại (như đã phân tích)

-- (Thứ tự xóa nên là bảng con trước, bảng cha sau cho an toàn)
...
SET SQL_SAFE_UPDATES = 1;     -- Bật lại chế độ Safe Update
...
INSERT INTO `nhanvien`(`MANV`, `TENNV`, `GIOITINH`, `CMND`, `NGAYSINH`, `SODIENTHOAI`, `EMAIL`, `DIACHI`, `NGAYTHAMGIA`, `MACHUCVU`, `IS_DELETED`) VALUES
    (1,'Huỳnh Khánh Duy',0,'3120410088','2005-06-11','0123456789','duyne@gmail.com','Nhà Bè, HCM','2025-10-16',1,0),
    (2,'Trang Thanh Phúc',0,'3120410413','2005-04-24','0123456798','phucne@gmail.com','Quận 8, HCM','2025-11-16',1,0),
    (3,'Trần Gia Lâm',0,'3120560051','2005-10-16','0123456518','lamne@gmail.com','Quận 8, HCM','2025-11-16',2,0),
    (4,'Võ Minh Tuấn',0,'3120410591','2005-08-11','0123456728','tuanne@gmail.com','Quận 8, HCM','2025-09-16',2,0),
    (5,'Vi Đào Tiến Đạt',0,'3120410125','2005-11-26','0123456738','datne@gmail.com','Quận 8, HCM','2025-12-16',1,0);

-- Insert Tài khoản
ALTER TABLE TAIKHOAN AUTO_INCREMENT = 1;
INSERT INTO `taikhoan`(`SOTK`, `TENTK`, `MATKHAU`, `MANV`, `SOLANSAI`, `NGAYTAO`, `IS_DELETED`) VALUES
    (1,'nhanvien','nhanvien',1,0,'2025-11-16',0),
    (2,'thanhphuc','123',2,0,'2025-11-16',0),
    (3,'gialam','123',3,0,'2025-11-16',0),
    (4,'admin','admin',4,0,'2025-11-16',0),
    (5,'tiendat','123',5,0,'2025-11-16',0);
...
INSERT INTO `voucher`(`SOVOUCHER`, `MAVOUCHER`, `MOTA`, `NGAYBD`, `NGAYKT`, `GIATRITOITHIEU`, `KMTOIDA`, `PTGIAM`, `SOLUOTSD`, `IS_DELETED`) VALUES
    (null,'NOVOUCHER','Không dùng voucher','2025-11-16','2200-12-16',0,0,0,100000,0),
    (null,'GIAM25K','Giảm 25k cho đơn từ 100k','2025-11-16','2025-12-16',100000,25000,100,5000,0),
    (null,'GIAM10PT','Giảm 10% tối đa 200k','2025-11-16','2025-12-16',0,200000,10,5000,0),
    (null,'GIAM25PT','Giảm 25% khi mua đơn tối thiểu 100k, giảm tối đa 100k','2025-11-16','2025-12-16',100000,100000,25,5000,0),
    (null,'GIAM50K','Giảm 50k khi mua đơn từ 200k','2025-11-16','2025-12-16',200000,50000,100,5000,0);
    
ALTER TABLE GIAMGIASP AUTO_INCREMENT = 1;
INSERT INTO `giamgiasp`(`SOPHIEU`, `NGAYBD`, `NGAYKT`, `PTGIAM`, `MASP`, `IS_DELETED`) VALUES
    (null,'2025-11-16','2025-12-16',15,1,0),
    (null,'2025-11-16','2025-12-16',5,3,0),
    (null,'2025-11-16','2025-12-16',10,4,0),
    (null,'2025-11-16','2025-12-16',20,7,0),
    (null,'2025-11-16','2025-12-16',16,10,0);
    
ALTER TABLE PHIEUNHAP AUTO_INCREMENT = 1;
INSERT INTO `phieunhap` (`MAPHIEU`, `NGAYLAP`, `MANV`, `IS_DELETED`) VALUES 
    (NULL, '2025-11-16 17:33:19', '1', '0'), 
    (NULL, '2025-11-17 17:33:19', '2', '0'),
    (NULL, '2025-11-17 17:35:19', '1', '0'),
    (NULL, '2025-11-17 17:39:19', '2', '0'),
    (NULL, '2025-11-17 16:12:19', '3', '0'), 
    (NULL, '2025-11-17 19:22:19', '1', '0'),
    (NULL, '2025-11-17 20:22:19', '2', '0'),
    (NULL, '2025-11-17 20:23:19', '1', '0'),
    (NULL, '2025-11-17 20:25:19', '3', '0'),
    (NULL, '2025-11-17 21:30:19', '1', '0'),
    (NULL, '2025-11-17 21:35:20', '3', '0'),
    (NULL, '2025-11-17 21:50:54', '5', '0'),
    (NULL, '2025-11-17 21:59:19', '5', '0');
...
INSERT INTO `phieuhuy` (`MAPHIEU`, `NGAYLAP`, `MANV`, `IS_DELETED`) VALUES 
    (NULL, '2025-11-16 17:54:45', '1', '0'), 
    (NULL, '2025-11-17 18:05:45', '2', '0'), 
    (NULL, '2025-11-17 18:34:49', '3', '0'), 
    (NULL, '2025-11-17 19:28:49', '5', '0'), 
    (NULL, '2025-11-17 21:55:49', '4', '0'), 
    (NULL, '2025-11-17 22:16:49', '2', '0');
